...
export class AutomationsController {
  ...
  create(@Body() dto: CreateAutomationRuleDto, @CurrentUser() user: AuthenticatedUser) {
    return this.automationsService.create(dto, ownerUserId(user));
  }
  ...
  update(
    ...
    return this.automationsService.update(id, dto, ownerUserId(user));
  }
  ...
  remove(@Param("id") id: string, @CurrentUser() user: AuthenticatedUser) {
    return this.automationsService.remove(id, ownerUserId(user));
  }
}
